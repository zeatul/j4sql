 ...
 * @author Hawk
 */
public class DefaultColumnUpdateClassNameTranslator implements Translator<Table, String> {
    @Nonnull
    @Override
    public String translate(@Nonnull Table table) {
        return UPPER_UNDERSCORE_TO_UPPER_CAMEL.convertTo(table.getName().toUpperCase()) + "ColumnUpdate";
    }
}
