 ...
 * @author Hawk
 */
public class DefaultGetterUpdatedNameTranslator implements Translator<Column, String> {
    @Nonnull
    @Override
    public String translate(@Nonnull Column column) {
        return "is" + UPPER_UNDERSCORE_TO_UPPER_CAMEL.convertTo(column.getName().toUpperCase()) + "Updated";
    }
}
