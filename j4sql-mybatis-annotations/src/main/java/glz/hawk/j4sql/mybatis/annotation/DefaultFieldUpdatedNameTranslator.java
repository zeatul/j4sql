 ...
 * @author Hawk
 */
public class DefaultFieldUpdatedNameTranslator implements Translator<Column, String> {
    @Nonnull
    @Override
    public String translate(@Nonnull Column column) {
        return UPPER_UNDERSCORE_TO_LOWER_CAMEL.convertTo(column.getName().toUpperCase()) + "Updated";
    }
}
