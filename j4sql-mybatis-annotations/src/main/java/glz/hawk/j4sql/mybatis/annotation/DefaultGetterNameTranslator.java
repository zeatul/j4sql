 ...
 * @author Hawk
 */
public class DefaultGetterNameTranslator implements Translator<Column, String> {
    @Nonnull
    @Override
    public String translate(@Nonnull Column column) {
        return "get" + UPPER_UNDERSCORE_TO_UPPER_CAMEL.convertTo(column.getName().toUpperCase());
    }
}
