 ...
 * @author Hawk
 */
public class DefaultSetterNameTranslator implements Translator<Column, String> {
    @Nonnull
    @Override
    public String translate(@Nonnull Column column) {
        return "set" + UPPER_UNDERSCORE_TO_UPPER_CAMEL.convertTo(column.getName().toUpperCase());
    }
}
