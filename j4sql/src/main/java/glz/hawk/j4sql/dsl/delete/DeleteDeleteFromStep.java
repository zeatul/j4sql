 ...
 * @author Hawk
 */
public interface DeleteDeleteFromStep {
    @Nonnull
    AfterDeleteDeleteFromClauseStep deleteFrom(PhysicalTable fromTable);

    @Nonnull
    AfterDeleteDeleteFromClauseStep deleteFrom(AliasedSqlTable<PhysicalTable> fromTable);
}
