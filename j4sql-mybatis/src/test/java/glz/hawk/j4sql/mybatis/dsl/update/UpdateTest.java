...
public class UpdateTest {
    ...
    public void updateTest() {
        Update update = update(BOOK)
            ...
            .build();
        System.out.println(new SqlBuilderImpl<>(configuration, MybatisSqlWriterImpl::new).build(update, new MybatisBuilderContextImpl("param")));
    }
